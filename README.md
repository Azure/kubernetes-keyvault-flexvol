...
2. Pass in properties for the Key Vault instance to the FlexVolume driver.
    ...
    |resourcegroup|required for version < v0.0.13|name of resource group containing Key Vault instance|""|
    |subscriptionid|required for version < v0.0.13|name of subscription containing Key Vault instance|""|
      ...
      - name: test
        flexVolume:
          ...
          options:
            ...
            resourcegroup: "testresourcegroup"        # [REQUIRED for version < v0.0.13] the resource group of the KeyVault
            subscriptionid: "testsub"                 # [REQUIRED for version < v0.0.13] the subscription ID of the KeyVault
